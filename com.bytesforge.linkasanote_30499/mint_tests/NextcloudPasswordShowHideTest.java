...
public class NextcloudPasswordShowHideTest {
    ...
    @Test
    public void nextcloudPasswordShowHideTest() {
                ...
                allOf(withId(R.id.account_password),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("p@ssw0rdT3st"), closeSoftKeyboard());
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.account_password), withText("p@ssw0rdT3st"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText.check(matches(withText("p@ssw0rdT3st")));
                ...
                allOf(withId(R.id.text_input_password_toggle), withContentDescription("Show password"),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                1)));
        checkableImageButton2.perform(scrollTo(), click());
