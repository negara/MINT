...
public class DeleteTwoLinksTest {
    ...
    public void deleteTwoLinksTest() {
                ...
                allOf(withId(R.id.link_link),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("https://www.facebook.com"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.link_name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText2.perform(scrollTo(), replaceText("Facebook"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.link_link),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText3.perform(scrollTo(), replaceText("https://twitter.com"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.link_name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText4.perform(scrollTo(), replaceText("Twitter"), closeSoftKeyboard());

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.link_name), withText("Twitter"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
        ...
        ViewInteraction appCompatCheckBox = onView(
                allOf(withId(R.id.link_checkbox), withContentDescription("Select Link"),
                        childAtPosition(
                                childAtPosition(
