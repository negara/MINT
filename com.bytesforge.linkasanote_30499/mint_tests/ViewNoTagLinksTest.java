...
public class ViewNoTagLinksTest {
    ...
    public void viewNoTagLinksTest() {
                ...
                allOf(withId(R.id.link_link),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("http://localhost"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.link_name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText2.perform(scrollTo(), replaceText("No Tag Link 1"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.link_link),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText3.perform(scrollTo(), replaceText("http://127.0.0.1"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.link_name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText4.perform(scrollTo(), replaceText("No Tag Link 2"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.title), withText("With no Tags"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.link_name), withText("No Tag Link 2"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("No Tag Link 2")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.link_name), withText("No Tag Link 1"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class),
                                        1),
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("No Tag Link 1")));
    }
