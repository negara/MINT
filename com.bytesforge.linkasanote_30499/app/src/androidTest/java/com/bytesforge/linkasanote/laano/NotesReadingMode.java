...
public class NotesReadingMode {
    ...
    public void notesReadingMode() {
                ...
                allOf(withId(R.id.note_note),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("New note"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.note_tags),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        tagsCompletionView2.perform(scrollTo(), replaceText("note"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.title), withText("Expand all Notes"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
