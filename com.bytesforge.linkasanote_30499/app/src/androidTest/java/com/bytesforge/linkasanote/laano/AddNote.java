                ...
                allOf(withId(R.id.note_note),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText6.perform(scrollTo(), replaceText("I added a link to Google website"));
//
//        ViewInteraction appCompatEditText7 = onView(
//                allOf(withId(R.id.note_note), withText("I addeddgog"),
//                        childAtPosition(
//                                childAtPosition(
//                                        withClassName(is("android.support.design.widget.TextInputLayout")),
//                                        0),
                ...
                allOf(withId(R.id.note_tags),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        tagsCompletionView2.perform(scrollTo(), replaceText("selfnote"));
