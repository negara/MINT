                ...
                allOf(withId(R.id.favorite_name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("android.google.com"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.favorite_tags),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        tagsCompletionView2.perform(scrollTo(), replaceText("Android"), closeSoftKeyboard());
